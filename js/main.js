...
(function ($) {
    ...
    try {
        $(".animsition").animsition({
            ...
            onLoadEvent: true,
            browser: [ 'animation-duration', '-webpkg-animation-duration'],
            overlay : false,
    ...
    try {
        ...
        var pkgPos2 = function() {
            if($(window).width() >= 1368) {
                var height = $('.pkg-pos2-1-1').outerHeight();
                $('.pkg-pos2').css('height', height + 'px');
            }
            else {
                $('.pkg-pos2').css('height', 'auto');
            }
